    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://linkedin.com/in/sandeep-prajapati-a01997224/" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://www.instagram.com/official_sandeep.pr/" aria-label="Instagram" data-social="instagram">
            <div className="filled" />
